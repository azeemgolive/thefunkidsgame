...
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
	<meta content="<?php echo $detail_game['meta_tag_keyword']; ?>" name="keywords"  />
        ...
        <meta property="og:image" content="http://www.thefunkids.com/games/game_images/<?php echo $detail_game['game_image']; ?>" />
        <title><?php echo $detail_game['game_title']; ?></title>
...
<section class="sec1">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12"> <object width="100%" height="500" data="games/game_files/<?php echo $detail_game['game_file']; ?>"></object></div>
   ...
   ?>
    ...
    <?php 
     ...
     $game_comments_view=  getGameCommentById($game_comment_id);
     $game_comment_view=  mysql_fetch_array($game_comments_view);     
    ?>
			<form method="post" action="doupdatepostgamecomments.php">
				<input type="hidden" name="game_id" value="<?php echo $game_id; ?>"/>
                                <input type="hidden" name="game_comment_id" value="<?php echo $game_comment_id; ?>"/>
...
{
?>         
<div class="share"> <a href="edit-kid-game-comments.php?id=<?php echo $game_id; ?>&game_comment_id=<?php echo $rhymecomment['game_comment_id']; ?>">Edit</a> | <a href="delete-game_comment.php?id=<?php echo $rhymecomment['game_comment_id']; ?>&rhyme_id=<?php echo $game_id; ?>">Delete</a> </div>
<?php
}
}   
?>     
