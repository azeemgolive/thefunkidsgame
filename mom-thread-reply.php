...
$sub_forum_thread=  mysql_fetch_array($thread_sub_forum);
 ?>
  ...
  ?>
      <div class="breadcrum"> <a href="mom-forum" style="color:#FFFFFF;">Mom Forum </a> > <a href="kid-mom-forum-<?php echo $sub_forum_thread['momforum_seo']; ?>" style="color:#FFFFFF;"><?php echo $sub_forum_thread['mom_sub_forum_title']; ?></a> > <a href="mom-forum-thread-<?php echo $threads['thread_seo']; ?>" style="color:#FFFFFF;"><?php echo $threads['thread_name']; ?></a> </div>
      <div class="col-md-9 bgwhite" style="">
        <h1 class="MOTHERING">Reply to Thread </h1>
        <form method="post" action="dopostreplythread.php" enctype="multipart/form-data" name="threadReplyForm" id="threadReplyForm">
          <input type="hidden" name="thread_id" value="<?php echo $threads['thread_id']; ?>">
          <input type="hidden" name="mom_sub_forum_id" value="<?php echo $threads['mom_sub_forum_id']; ?>">
