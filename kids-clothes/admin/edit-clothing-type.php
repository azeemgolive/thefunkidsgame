      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
              ...
              <li><a href="clothes-type.php"><i class="fa fa-dashboard"></i> Clothing Types</a></li>
            <li class="active">update clothing type</li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <?php
                 $clothing_types=  getAllClothingTypeById($_REQUEST['id']);
                 $clothing_type=  mysql_fetch_array($clothing_types);
                ?>
                <form role="form" method="post" action="updateClothingType.php" enctype="multipart/form-data">
                    <input type="hidden" name="clothing_type_id" value="<?php echo $clothing_type['clothing_type_id'];  ?>">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Clothing Type Name</label>
                      <input type="text" name="Clothing_type_name" class="form-control" id="Clothing_type_name" value="<?php echo $clothing_type['Clothing_type_name'];  ?>" placeholder="Enter Clothing type name">
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <select name="clothing_type_gender" id="product_gender">
