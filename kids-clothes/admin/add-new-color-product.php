      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
              ...
              <li><a href="products-colors.php"><i class="fa fa-dashboard"></i> Products Colors</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="addNewcolor.php" enctype="multipart/form-data">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Color Name</label>
                      <input type="text" name="color_name" class="form-control" id="color_name" placeholder="Enter product name">
                    </div>                 
