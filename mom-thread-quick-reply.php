...
$sub_forum_thread=  mysql_fetch_array($thread_sub_forum);
 ...
 <?php
  ...
  ?>   
<div class="breadcrum">
    <a href="mom-forum" style="color:#FFFFFF;">Mom Forum </a> > <a href="kid-mom-forum-<?php echo $sub_forum_thread['momforum_seo']; ?>" style="color:#FFFFFF;"><?php echo $sub_forum_thread['mom_sub_forum_title']; ?></a> > <a href="mom-forum-thread-<?php echo $threads['thread_seo']; ?>" style="color:#FFFFFF;"><?php echo $threads['thread_name']; ?></a>
</div>

<div class="col-md-9 bgwhite" style="">
    
  <h1 class="MOTHERING">Quick Reply to Thread </h1>
  <form method="post" action="dopostquickreplythread.php" enctype="multipart/form-data" name="newQuickReplyThreadForm" id="newQuickReplyThreadForm">
