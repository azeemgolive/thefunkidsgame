...
<div class="row">
      <div class="col-lg-12">
        <div class="new-puzzle" style="width:98.8%">
          ...
          <div class="row">
            <?php 
            $kid_puzzles=getAllNewGames();
            if($kid_puzzles>0)
            {
              while($kid_puzzle=  mysql_fetch_array($kid_puzzles))
              {
            ?>
            <a href="kid-puzzle-<?php echo $kid_puzzle['seo_game'];  ?>" onClick="ga('send', 'event', 'Kids <?php echo $kid_puzzle['game_name']; ?>', 'Play Kids <?php echo $kid_puzzle['game_name']; ?>');">
                <div class="col-md-2"> <img src="games/game_images/<?php echo $kid_puzzle['game_image']; ?> " alt="" class="img-responsive"/>
              <p class="puzzle-paras" align="center"> <?php echo $kid_puzzle['game_name']; ?>  </p>
            </div>
              </a>
            <?php
            }
            ...
            <div class="col-md-2"> <img src="funkid-puzzles/puzzle_images/coming-soon-1.jpg" alt="" class="img-responsive"/>
              ...
              <a href="">
            <div class="col-md-2"> <img src="funkid-puzzles/puzzle_images/coming-soon-2.jpg" alt="" class="img-responsive"/>
              <p class="puzzle-paras" align="center"> Coming Soon.. </p>
            </div>
              </a>
