 package 
{
	...
	public class TriviaList extends MovieClip
	{
...
//100 WORDS.
			...
			Clues=[
/* 1 */         "          is the 6th largest nation of the world containing one of the oldest civilizations in history.",
/* 2 */			"Pakistan holds four out of fourteen highest peaks in the world.         is the second highest mountain in the world.",
/* 3 */			"          has world’s largest irrigation system.",
...
/* 12 */			"The International Court of Justice is located in            .",
/* 13 */			"There are            members of SAARC.",
/* 14 */			"Organization of Islamic Cooperation (OIC) has          official languages.",
/* 15 */			"There are          non-permanent members of the security council.",
/* 16*/			"The currency of Indonesia is           .",
/* 17 */			"The D-8 is an organization of eight          countries.",
/* 18 */			"The European Union's working capital is in           .",
/* 19 */			"The headquarter of NATO is located in           .",
/* 20 */			"The motto of UNO is             .",
/* 21 */			"The world's highest mountain is in            .",
/* 22 */			"The headquarter of Red Cross is in           .",                    
/* 23 */			"World Trade Organization was established in             .",
/* 24 */			"The North Atlantic treaty (NATO) was signed in          .",
/* 25 */			"Which country, on the map of world, appears as 'Long Shoe'?",
/* 26 */			"Which from the following countries is NOT a member of D-8?",
/* 27 */			"The largest ocean of the world is            .",
/* 28 */			"Which from the following countries does NOT yeild veto-power?",
/* 29 */			"OIC changed its name from Organisation of the Islamic Conference to Organization of Islamic Cooperation in _________.",
/* 30 */            "Pakistan was created in the year        .",
/* 31 */			"World War II in Europe was outbreak by the German invasion of            .",
/* 32 */			"United States was discovered by Christopher Columbus during his voyage in          .",
/* 33 */			"In United States, the Congress declared independence from Great Britain on             .",
/* 34 */			"North Atlantic Treaty of NATO was signed on           in Washington D.C.",
/* 35 */			"In the war of 1812 between 13 States of US and Great Britain; Britain set fire to White House in             .",
/* 36 */			"World War I was lasted from?",
/* 37 */			"World War II was lasted from?",
/* 38 */			"Which is the outermost planet in the solar system?",
/* 39 */			"The SI unit of charge is          .",
/* 40 */			"Very High Frequency (VHF) have            wavelengths.",
/* 41 */			"Long-sight defect could be corrected by using              lens.",
/* 42*/			"Deficiency of Vitamin-A results in            .",
/* 43 */			"For a fixed mass of gass at constant temperature, if we decrease volume, the pressure will           .",
/* 44 */			"The lifespan of Red Blood Cells is           days.",
/* 45 */			"The density of water is          .",
/* 46 */			"Radioactivity was discovered by           .",
/* 47 */			"A device which converts chemical energy into electrical energy is called             .",
/* 48 */			"The Sun is a          .",
/* 49 */			"The average adult has a blood volume of about              liters.",
/* 50 */			"The most abundant element in the universe is              .",
/* 51 */			"The most abundant element in the Earth's crust is               .",
/* 52 */			"Each day human body breathe in              liters of air.",
/* 53 */			"Deficiency of Vitamin-D results in             .",
/* 54 */			"The SI unit of 'pressure' is               .",
/* 55 */			"The most densest substance on the Earth is             .",
/* 56 */			"A camera uses a        to form an image.",
/* 57 */			"Which from the following is NOT a conductor?",
/* 58 */			"CNG stands for?",
/* 59 */			"Which from the following is true for Sound?",
/* 60 */			"When white light is passed through a prism, it splits into            colours.",
/* 61*/			"1 nanometer = ?",
/* 62*/			"Instrument used for measuring very high temperature is            .",
/* 63*/			"Sound waves are _________ waves.",
/* 64 */			"The lifespan of White Blood Cells is              day(s).",
/* 65 */			"The fluid part of blood is known as               .",
/* 66*/			"X-rays were discovered by              .", 
/* 67 */			"The speed of light is             .",
/* 68 */			"During winter in cold countries, the            is mixed to melt the ice on the icy roads.",
/* 69 */			"The salinity of sea water is determined by the amount of common salt (Sodium Chloride) in               of sea water.",
/* 70 */			"The planet which is easily visible from the Earth is?",
/* 71 */			"The Great Spot is a               .",
/* 72 */			"The Great Spot is on the planet               .",
/* 73 */			"According to Big Bang Theory, the Universe began about               billion years ago.",
/* 74 */			"The planets visible to us without using a telescope are              .",
/* 75*/				"The bodyguard of the Earth is               that save the Earth from many Comets and Asteroids.",
/* 76 */			"Biosensor is used to measure?",
/* 77 */			"Which country is called Land of thousand islands?",
/* 78 */			"Indonesia is an archipelago comprising approximately              islands.",
...
/* 82 */			"In general, Comets have              orbits.",
/* 83 */			"GPS is an abbreviation for?",
/* 84 */			"Oxidation is a chemical reaction involving the             .",
/* 85 */			"At night, Plants intake               and release              .",
/* 86 */			"Urine is produced in              .",
/* 87 */			"Blood is cleaned by           .",
/* 88 */			"The position of an element in the Periodic Table is determined by its                number.",
/* 89 */			"The salinity of sea water is determined by the amount of common salt (Sodium Chloride) in            of sea water.",
/* 90 */			"The planet which is easily visible from the Earth is?",
/* 91 */			"Vienna is the capital of            .",
/* 92 */			"The capital of Czech Republic is?",
/* 93 */			"AFP is the news agency of             .",
/* 94  */			"ANTARA is the news agency of             .",
/* 95  */			"Emirates is an airline of               .",
/* 96  */			"Qantas is an airline of                .",
/* 97  */			"The world's longest bridge, Danyang–Kunshan Grand Bridge, is in                .",


/* 100*/			"The first Nobel Prize was awarded in              .",
/* 101 */			"The Nobel Prize has been awarded in              fields.",
/* 102 */			"The Nobel Peace Prize 2012 in the field of 'Peace' was awarded to?",
/* 103 */			"SANA is the news agency of             .",
/* 104 */			"Saba is the news agency of             .",
/* 105 */			"KLM is an airline of                .",
/* 106 */			"Etihad Airways is an airline of            .",
...
/* 11- A */			"a)Vatican City, b) Afghanistan, c) North Korea, d)Vietnam,",
/* 12- C */			"a)New York, b) Washington, d) Geneva, e)The Hague.",
...
/* 18- D*/			"a)London, b) Lisbon, c) Austria, d)Brussels,",
...
/* 22- D*/			"a)New York, b) Washington, c) Geneva, d) The Hague,",
...
/* 30 -A*/        		              "a)1947, b)1949, c)1946, d)1950,",
/* 31- B*/			"a)American, b)Poland, c)German, d)French,",
/* 32- D*/	        		 "a)1486,b)1488,c)1490,d)1492,",
/* 33- C*/			"a)July 4-1774, b)July 4 - 1775,c)july 4-1776, d)July 4-1777, d)April 04-1947,",
...
/* 52- C */			"a) 5000 to 10000, b) 10000 to 15000 ,c) 15000 to 20000 , d)  20000 to 25000,",
...
/* 67 - B */			"a)280000 km/s, b)300000 km/s, c)320000 km/s, d)none of these,",
...
/* 78 - D*/			"a)  10000,b)12500,c)15000,d)17500,",
