...
<section class="sec1">
  <div class="container">
	...
	?>
    <?php 
     $puzzle_comment_id=$_REQUEST['puzzle_comment_id'];
     $rhyme_comments_view=  getPuzzleCommentById($puzzle_comment_id);
     $rhyme_comment_view=  mysql_fetch_array($rhyme_comments_view);     
    ?>
    <form method="post" action="doeditpuzzlecoment.php">
      <input type="hidden" name="puzzle_comment_id" value="<?php echo $puzzle_comment_id; ?>"/>
