...
{
$seo=substr($seo, 14);
$seo=rtrim($seo,'comment#funlearn');
$seo=substr_replace($seo, '', -1);
}else
{
  $seo=substr($seo, 14);   
}
$rhymedetails=getFunLearnBySeo($seo);
$detailrhyme=  mysql_fetch_array($rhymedetails);
$rhyme_id=$detailrhyme['fun_learn_id'];
?>
<!doctype html>
<html lang="en">
<head>
...
<title><?php echo $detailrhyme['fun_learn_title']; ?></title>
...
<script type="text/ javascript">
 ...
 <meta property="og:image" content="http://www.thefunkids.com/fun_learns/fun_learn_images/<?php echo $share_kidsfun_image=$rhyme_id=$detailrhyme['fun_learn_image']; ?>" />
...
<section class="sec1">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12"> 
      <?php  
      echo $detailrhyme['fun_learn_code'];  
      ?>
      </div>
     
	<?php
  $rhymeimage="http://www.thefunkids.com/rhymes/".$detailrhyme['fun_learn_image'];  
  $title=urlencode($detailrhyme['fun_learn_name']);  
  $url=urlencode('http://www.thefunkids.com');
  $summary=urlencode($detailrhyme['fun_learn_decription']);
  ...
  ?>
   ...
   ?>
	...
	?>
			<form method="post" action="dopostfunlearncomments.php">
				<input type="hidden" name="fun_learn_id" value="<?php echo $detailrhyme['fun_learn_id']; ?>"/>
...
<?php
    ...
    $rhyme_comment=getApproveFunLearnComment($rhyme_id);
    if($rhyme_comment>0)
    {
...
{
?>         
<div class="share"> <a href="edit-funlearn-comment.php?id=<?php echo $detailrhyme['fun_learn_id']; ?>&funlearn_comment_id=<?php echo $rhymecomment['fun_learn_comment_id']; ?>"> Edit | </a>  <a href="delete-funlearn-comment.php?id=<?php echo $rhymecomment['fun_learn_comment_id']; ?>&fun_learn_id=<?php echo $rhyme_id; ?>">Delete</a> </div>
<?php
}
}   
?>     
