...
<div class="row row2">
<img src="images/yellow2.png" alt="" class="badal"/>
</div>
</div>
</section>
<section class="secondyellow">
<div class="container">
...
if($grand_puzzle>0)
{
    ...
    {
        ?>
<a href="view-puzzle.php?id=<?php echo $grand_puzzles['puzzle_id'];  ?>">
<div class="games">
<img src="puzzles/puzzle_slider/<?php echo $grand_puzzles['slider_image']; ?>" alt="" class="img-responsive"/>
<p class="text-center" style="color:#FFF;"><?php echo $grand_puzzles['puzzle_name']; ?></p>
</div>
</a>
<?php
    }
...
<div class="col-md-2 puzzelad">
<?php
include("gadds.php");
?>
</div>

<div class="col-md-8 inters">
...
<div class="container-fluid">
<div class="row">
<img src="images/yellow1.png" alt="" class="footercloud"/>
</div>
</div>
</section>
<?php
