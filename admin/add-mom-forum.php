      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">add new forum</li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="doaddmomforum.php">
                  
                    <div class="form-group">
                      <label for="exampleInputEmail1">Title</label>
                      <input type="text" name="mom_forum_title" class="form-control" id="exampleInputEmail1" placeholder="please enter Title">
                    </div>                    
