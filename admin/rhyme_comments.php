      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Rhyme Comments</li>
          </ol>
        </section>
            ...
            <div>
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Rhyme Comments</h3>
                  ...
                  <div class="table-responsive">
                    <table class="table no-margin">
                      ...
                      <tbody>
                         ...
                         ?>
                          <tr>       
                          <th><?php echo $topmenu[0]; ?></th>
                          <th><?php echo $topmenu[2]; ?></th>    
                          <td><?php echo $topmenu[3]; ?></td>
                          <td><a href="approvecomment.php?id=<?php echo $topmenu[6] ?>">
                              <span class="label label-success"><?php if($topmenu[5]=='yes')
                              {
                              echo "Active";                              
                              }else{
                                  echo "Not Active";
