	...
	prototype: {
		...
		showdiv: function(element, message) {
			...
			if ( div.length ) {
				...
				div.removeClass().addClass( this.settings.errorClass );



				// check if we have a generated div, replace the message then

				div.attr("generated") && div.html(message);
				...
				if ( !this.divContainer.append(div).length )
