          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="doaddstory.php" enctype="multipart/form-data">
                  
                    <div class="form-group">
                      <label for="exampleInputEmail1">Story Name</label>
                      <input type="story_name" name="story_name" class="form-control" id="exampleInputEmail1" placeholder="Enter story name">
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <textarea class="form-control" rows="3" name="story_code" id="story_code"></textarea>
                    
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Story Description</label>
                      <textarea class="form-control" rows="3" name="story_description" id="story_description"></textarea>
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Story Slider</label>
