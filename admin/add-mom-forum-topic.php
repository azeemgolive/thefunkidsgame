      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">add new forum topics</li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="doaddmomforumtopic.php" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                      ...
                      <select class="form-control" name="mom_forum_id">
                          ...
                          if($mom_forum>0)
                          {
                              ...
                              {
                          ?>
                          <option value="<?php echo $momforum['mom_forum_id'];  ?>"><?php echo $momforum['mom_forum_title'];  ?></option>
                          <?php
                              }
                          }
                          ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="mom_sub_forum_title" class="form-control" id="exampleInputEmail1" placeholder="please enter Title">
                    </div> 
